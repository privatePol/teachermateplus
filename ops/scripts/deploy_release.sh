...
APP_DIR="${APP_DIR:-/opt/edugradespro}"
VENV_BIN="${VENV_BIN:-/opt/edugradespro/.venv/bin}"
ENV_FILE="${ENV_FILE:-/etc/edugradespro/edugradespro.env}"
SERVICE_NAME="${SERVICE_NAME:-edugradespro-gunicorn}"
BRANCH="${BRANCH:-main}"
