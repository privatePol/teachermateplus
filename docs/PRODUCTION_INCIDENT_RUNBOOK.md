# TeacherMate+ Production Incident Runbook

This runbook is the operational response guide for production issues in TeacherMate+.
...
This runbook assumes the Ubuntu deployment flow documented in [DEPLOYMENT_UBUNTU.md](/d:/teachermateplus/docs/DEPLOYMENT_UBUNTU.md).
...
```bash
sudo ls -lah /var/log/teachermateplus/
sudo tail -n 200 /var/log/teachermateplus/*.log
```
...
> TeacherMate+ is currently experiencing a production issue affecting [portal/feature].  
...
> TeacherMate+ service has been restored for [portal/feature].  
...
## 16. TeacherMate+ Production Readiness Checklist
...
If TeacherMate+ suddenly shows production errors:
