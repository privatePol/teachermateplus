...
These instructions apply to the current EduGradesPro production server while it is **not yet live** and is being used only by limited testing users.

## Current Situation

- The production server already has EduGradesPro running.
