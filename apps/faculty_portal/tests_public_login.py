...
class FacultyPublicLoginTests(TestCase):
    ...
    def test_public_faculty_login_form_posts_to_landing_page(self):
        ...
        self.assertContains(response, "fp-logo-starfield")
        self.assertContains(response, "fp-logo-star star-24")
        self.assertContains(response, "fp-logo-starfield fp-logo-starfield-neon")
        self.assertContains(response, "fp-logo-star fp-logo-star-neon star-24")
