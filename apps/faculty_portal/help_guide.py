        ...
        "topics": [
            {
                ...
                "actions": [
                    ...
                    {"name": "Create Case-Based Question Group", "does": "When the tenant enables Structured Case/Scenario lifecycle for a frozen Manual Review exam, creates one Case / Scenario by pasting clipboard content from Microsoft Word, reviewing the server-sanitized preview, and then adding ordinary Linked MCQs beneath it. Supported content includes paragraphs, headings, bold/italic, lists, multiple accounting tables and safe merged cells, left/center/right alignment, Unicode and ₱, superscript/subscript, and TMP \\(...\\) or \\[...\\] notation.", "when": "Use it only in a mutable structured Manual Review contribution. Select the frozen Exam Section when the exam uses sections; every Linked Question automatically uses that same section and counts as one quota item.", "avoid": "Do not upload a DOCX for Case content, paste images/diagrams or native Word equations, or expect pixel-perfect Word layout. Replace native equations with TMP LaTeX or Unicode. Never paste another contributor's confidential content.", "result": "TeacherMate+ stores bounded canonical semantic HTML only after the server removes unsupported Word metadata and active markup. The Case narrative does not count toward quota; every Linked MCQ retains its own choices, correct answer, difficulty, and order.", "editable": "The Case and Linked Questions are editable/reorderable only while the contribution remains mutable. A Case must contain at least one Linked Question before Final Submission."},
