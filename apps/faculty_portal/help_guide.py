        ...
        "topics": [
            {
                ...
                "actions": [
                    {"name": "Add or Edit Question", "does": "Saves plain-text question text, four distinct choices, one correct answer, and Easy, Moderate, or Difficult difficulty. Normal Unicode and meaningful line breaks are supported; markup-looking text is displayed literally rather than interpreted as HTML.", "when": "Use it while the contribution is an Active Draft and before the deadline.", "avoid": "Do not enter images, tabs, control or bidirectional formatting characters, another contributor's content, or more than the exact quota.", "result": "The question is saved in your private workspace with a stable position.", "editable": "Editable only while the contribution remains an Active Draft."},
