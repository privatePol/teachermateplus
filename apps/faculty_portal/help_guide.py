        ...
        "topics": [
            {
                ...
                "actions": [
                    ...
                    {"name": "Print Questionnaire", "does": "Opens the separately released exact generated revision as sanitized Set A or Set B printer-friendly HTML.", "when": "Use Print Set A or Print Set B only while the authorized Print From/Until window is active and your current accepted teaching assignment remains valid.", "avoid": "Do not expect a newer regenerated revision to appear until an authorized administrator releases it, and do not share the confidential questionnaire.", "result": "The official tenant header, course scope, released revision, questions, choices, and print timestamp are shown without answers or internal generation metadata.", "editable": "No. Printing is read-only, audited, and denied outside the exact release window."},
                ],
