...
FACULTY_HELP_SECTIONS = [
    {
        ...
        "topics": [
            ...
            },
            {
                ...
                "how_to_open": ["From the left navigation bar, open Classroom Tools.", "Click Exit Pulse to open the dashboard. Use Assignment Comparison to compare your authorized classes, or click Create Exit Pulse for a new Learning Check."],
                "check_first": [
                ...
                "actions": [
                    ...
                    {"name": "View Results", "does": "Shows counts, percentages, response rate, understanding rate, support-needed rate, and enabled anonymous comments. Older sessions without a stored enrollment count clearly label the current class count and response rate as estimates.", "when": "Use it after the session closes or expires.", "avoid": "Do not use anonymous responses as proof of attendance or as grades.", "result": "A basic session summary helps identify material that may need clarification or more practice.", "editable": "Results are read-only and available only to the assigned faculty owner."},
                    ...
                    {"name": "Open Class History", "does": "Lists completed Exit Pulse sessions for one current or historical assignment with date, question type, topic, and status filters.", "when": "Use View History from the dashboard when you need older session results.", "avoid": "Do not copy or disclose anonymous written feedback from the history list; open the owner-only result only when needed.", "result": "Only your own tenant- and campus-scoped history is available, including records from an assignment that is no longer current.", "editable": "History and results are read-only; a historical assignment cannot start a new session."},
