...
FACULTY_HELP_SECTIONS = [
    {
        ...
        "topics": [
            ...
            },
            {
                ...
                "how_to_open": ["From the left navigation bar, open Classroom Tools.", "Click Exit Pulse to open the dashboard. Click Create Exit Pulse when you need a new Learning Check."],
                "check_first": [
