...
class FacultyHelpGuideTests(TestCase):
    ...
    def test_revised_faculty_guide_explains_zero_blank_and_base_50(self):
        ...
        self.assertContains(response, "the heart as a like button; it means strong understanding and confidence")
    ...
    def test_floating_help_button_opens_faculty_quick_guide(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'class="help-fab"', html=False)
