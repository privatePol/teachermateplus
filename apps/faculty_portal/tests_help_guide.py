...
class FacultyHelpGuideTests(TestCase):
    ...
    def test_revised_faculty_guide_explains_zero_blank_and_base_50(self):
        ...
        self.assertContains(response, "Start Here: Daily Faculty Workflow")
        self.assertContains(response, "imahe/faculty_workflow.png")
        self.assertContains(response, "Top Faculty Tasks")
        self.assertContains(response, "Open Student Consultation View for one student")
