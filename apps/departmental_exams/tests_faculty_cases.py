...
class FacultyCaseWorkflowTests(FacultyCaseFixtureMixin, Stage4TestCase):
    ...
    def test_interleaved_cases_display_contiguously_without_persistent_renumbering(self):
        ...
        self.assertContains(workspace, f'id="qb-case-{first_case.id}"')
        self.assertContains(workspace, f'id="qb-question-{first.id}"')
        self.assertContains(workspace, f'id="qb-question-{standalone.id}"')
