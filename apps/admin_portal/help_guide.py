        ...
        "topics": [
            ...
            },
            {
                ...
                "steps": [
                    ...
                    "Use the Release Center tabs to keep Questionnaire Releases and Answer Key Releases separate. Both tabs keep selected exact targets while Course, Department, and Release Status filters change what is visible. The selected total and hidden-selected count show the complete batch; use Show selected or Clear selection as needed. Select All Visible changes only visible, eligible rows. Changing the cycle clears affected selections. In Bulk Answer Key Release, first select an explicit Target Campus and load its recipient courses; changing campus clears only Answer Key selections.",
