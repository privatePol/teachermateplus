        ...
        "topics": [
            {
                ...
                "actions": [
                    ...
                    {"name": "Automatic Generation Readiness", "does": "Opens a separate cycle-bounded screen/print report with effective faculty quota, completion, campus requirements, usable pool feasibility, execution status, and concrete action for authorized Automatic courses.", "when": "Use it before or after the deadline to distinguish current question-pool feasibility from deadline, roster, lifecycle, and processing gates.", "avoid": "READY describes exact current pool feasibility only; under the configured campus policy it can include a named warning for a campus with no usable Submitted representation.", "result": "READY or NEEDS QUESTIONS, any academic-facing campus warning, and one of READY FOR GENERATION, WAITING FOR DEADLINE, FACULTY INCOMPLETE, BLOCKED, GENERATED, or EXEMPT.", "editable": "Both screen and print are GET-only, aggregate-only, and never start generation."},
        ...
        "topics": [
            {
                ...
                "steps": [
                    ...
                    "From Contributor Completion, open Automatic Generation Readiness and select one authorized cycle. Review the materialized DEFAULT/OVERRIDE faculty quota, explicit campus Required and Available values, READY or NEEDS QUESTIONS pool result, Automatic Generation Status, and Action Needed. The report works before the deadline and never starts processing or exposes confidential questions.",
