        ...
        "topics": [
            ...
            },
            {
                ...
                "steps": [
                    ...
                    "Use Print Set A or Print Set B for Admin-only printing when Faculty release is unnecessary. Choose Letter (default), A4, or Legal before opening the browser print dialog. Admin Direct Print does not create, replace, or extend a Faculty release.",
