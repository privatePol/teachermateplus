...
class AdminHelpGuideTests(TestCase):
    ...
    def test_departmental_exam_output_guides_cover_release_and_audit_operations(self):
        ...
        self.assertIn("hidden-selected count", guide_text)
        self.assertIn("Show selected or Clear selection", guide_text)
        self.assertIn("View details", guide_text)
        ...
        self.assertContains(practical, "View details")
        self.assertContains(practical, "hidden selections")
