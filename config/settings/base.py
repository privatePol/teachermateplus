...
FACULTY_IMPORT_EMAIL_ENABLED = env_bool("FACULTY_IMPORT_EMAIL_ENABLED", False)
FACULTY_INVITATION_EXPIRY_HOURS = max(1, int(os.getenv("FACULTY_INVITATION_EXPIRY_HOURS", "24")))
...
EXIT_PULSE_VERIFICATION_BROWSER_RATE_LIMIT_PER_MINUTE = int(
    os.getenv("EXIT_PULSE_VERIFICATION_BROWSER_RATE_LIMIT_PER_MINUTE", "6")
)
