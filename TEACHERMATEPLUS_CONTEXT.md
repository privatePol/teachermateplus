...
- The Active Course Offerings table shows Schedule Text instead of separate Campus and Term columns. Campus, academic-year, and term filtering remains available above the table, and the Inactive Course Offerings table retains its existing Campus and Term columns for maintenance context.
